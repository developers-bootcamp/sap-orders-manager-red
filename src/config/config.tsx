...
export { GET_ALL_ORDERS_URL, LOG_IN, PALLETE, GET_CURRENCIES, SIGN_UP , UPDATE_ORDER,GET_ALL_CATEGORY,GET_ALL_PRODUCT,DELETE_CATEGORY,EDIT_CATEGORY,ADD_CATEGORY,DELETE_PRODUCT, EDIT_PRODUCT,ADD_PRODUCT};
